# Letting 6a8bca67-45a3-428e-85ba-71ec2cd2218e trade - the steps YOU would take
...
1. Review the registry entry (`data/created/6a8bca67-45a3-428e-85ba-71ec2cd2218e.json`), its audit
   records, and the latest brief. Confirm this is the revision you mean.
2. If archived (disposition: archived): restore it yourself -
   `restore_strategy` with strategyId `6a8bca67-45a3-428e-85ba-71ec2cd2218e` and the CURRENT revision
